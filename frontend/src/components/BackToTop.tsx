...
export function BackToTop() {
  ...
  return (
    <button
      onClick={scrollTop}
      title="Back to top"
      className="fixed bottom-24 right-6 z-[9000] p-3 rounded-full bg-slate-800 border border-slate-700 text-slate-300 hover:bg-slate-700 hover:text-white shadow-xl transition-all duration-200 hover:scale-110 active:scale-95"
    >
      <ArrowUp size={18} />
    </button>
  );
